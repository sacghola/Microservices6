...
public class LoansController {
    ...
    @Operation(
            ...
            description = "Get java version Information that is deployed into loans microservices"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
    ...
    @Operation(
            ...
            description = "Get contact Information that is deployed into loans microservices"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
